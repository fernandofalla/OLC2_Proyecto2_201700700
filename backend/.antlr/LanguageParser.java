...
public class LanguageParser extends Parser {
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			"'len'", "'append'", "'strconv.Atoi'", "'fmt.Println'", "'strconv.ParseFloat'", 
	...
	@SuppressWarnings("CheckReturnValue")
	public static class StringToIntContext extends ExprContext {
		public ExprContext expr() {
			return getRuleContext(ExprContext.class,0);
		}
		public StringToIntContext(ExprContext ctx) { copyFrom(ctx); }
	}
	@SuppressWarnings("CheckReturnValue")
